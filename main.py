    ...
    if simulation_settings == "from_main_script":
        ...
        general_simulation_parameters = pd.DataFrame(
            [[
                ...
                False,  # "show_video". Boolean to enable or disable the simulation video display regarding the grid and the configured BSs and EDs with their mobility behaviour. (The link computation is executed after we closed the video).
